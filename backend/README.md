...
## Project Structure
    ...
    ├── delicate_tooth_dev_100248  # Django project configurations
...
1. Clone this repo and `cd delicate_tooth_dev_100248`
...
2. Clone this repo and `cd delicate_tooth_dev_100248`
